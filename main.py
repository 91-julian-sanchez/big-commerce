...
def run(
    ...
    if marketplace_uid == 'mercadolibre':
        ...
        category_glossary_df = pd.concat([level2_df, level3_df, level4_df])
        
    elif marketplace_uid == 'linio':
        category_glossary_df = df[df['id']==category_id]
        
    for index, row in category_glossary_df.iterrows():
